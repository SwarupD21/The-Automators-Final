...
function addSecurityHeaders() {
    ...
    const securityMeta = [
        { name: 'Content-Security-Policy', content: "default-src 'self' 'unsafe-inline' https://apis.google.com https://accounts.google.com; script-src 'self' 'unsafe-inline' https://apis.google.com https://accounts.google.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://raul60.app.n8n.cloud;" },
